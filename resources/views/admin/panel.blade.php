...
<div style="text-align: center;">
                            ...
                            <a class="quick-btn" href="{{url('/admin/requests')}}">
                                <i class="icon-comment icon-2x"></i>
                                <span>Requests</span>
                                <span class="label label-success"><?php $Comments = DB::table('servicerequests')->where('status','0')->get(); $Count = count($Comments); echo $Count ?> || <?php $Comments = DB::table('quoterequests')->where('status','0')->get(); $Count = count($Comments); echo $Count ?></span>
                            </a>
                            ...
                            <a class="quick-btn" href="{{url('/admin/users')}}">
                                ...
                                <span>Clients</span>
                                <span class="label label-success"><?php $Admins = DB::table('users')->get(); $Count = count($Admins); echo $Count ?></span>
                            </a>
