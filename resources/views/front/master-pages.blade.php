...
<head>
        ...
        <title><?php echo $page_title; ?> || Designekta Studios</title>

        <meta name="google-site-verification" content="e8c2n1NdxeVcgx7pLdZ3mrUO4aZq8o7_UrJbdtGL62s" />
        <!-- SEO META -->
        <meta name="description" content="Designekta studios is a Custom Web Design firm that deals in Web Development and Graphics Design" />
        ...
        <link rel="canonical" href="https://designekta.com/{{$cannonical}}"/>
        {{-- OG --}}
        ...
        <meta property="og:url" content="https://designekta.com/{{$cannonical}}" />
        ...
        <link rel="stylesheet" href="{{asset('theme/assets/css/theme-indigo.css')}}">
          ...
          <script type="text/javascript">
            ...
            <!--End of Tawk.to Script-->
             <!--<script data-ad-client="ca-pub-7294987100142322" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>-->
    ...
    <body>
                ...
                <div class="container header">
                    ...
                    <ul class="navbar-nav action">
                        <li class="nav-item ml-3">
                            <a style="padding-right:1.3em; padding-left:1.3em" href="#contact" class="smooth-anchor nav-link btn ml-lg-auto primary-button"><i class="icon-speech"></i>Get Quote</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        =============================================== -->
        <script src="../www.google.com/recaptcha/api9516.js?render=6Ldb6DEaAAAAANbQ7D9m1CKqc8e4MiV5yzd3kTWf"></script>
